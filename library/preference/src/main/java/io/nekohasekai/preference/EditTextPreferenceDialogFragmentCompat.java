...
import androidx.preference.EditTextPreferenceWrapper;
...
public class EditTextPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {
    ...
    protected void onBindDialogView(@NonNull View view) {
        ...
        EditTextPreference.OnBindEditTextListener listener = EditTextPreferenceWrapper.getOnBindEditTextListener(getEditTextPreference());
        if (listener != null) {
